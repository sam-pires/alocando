...
# destroy FlightBundleFlight and FlightBundle datasets
puts "FlightBundleFlight: #{FlightBundleFlight.count}"
puts "FlightBundle: #{FlightBundle.count}"
puts "destroy FlightBundleFlight and FlightBundle datasets"
...
if City.count == 4925
  ...
  puts "Airline and City details are already there."
end
